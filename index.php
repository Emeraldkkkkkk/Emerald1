...
<head>
  <meta charset="UTF-8" />
  <meta name="description" content="Quantrack AI - AI for Augmented Business Intelligence" />
  ...
  <script src="https://www.google.com/recaptcha/api.js?render=<?= $_ENV["PUBLIC_KEY"] ?>"></script>
  <script>
    grecaptcha.ready(function() {
      grecaptcha.execute("<?= $_ENV["PUBLIC_KEY"] ?>", {
        action: 'contact'
      }).then(function(token) {
  ...
  <header>
    <nav id="nav">
      <div id="logo-container">
        <img id="logo" src="./sources/img/quantrack-logo.png" alt="quantrack logo" />
      </div>
  ...
  <main>
    <section id="section-header">
      <div id="claim">
        <article id="article-header">
          ...
          <a class="btnlink" href="#section-quote">Get a quote <span><i class="fas fa-chevron-right"></i></span></a>
        </article>
        <div id="divdiscover">
          <span id="spandiscover"></span><a href="#section-products" id="discover">Discover our products</a>
        </div>
      </div>
    </section>
      ...
      <section id="section-contact">
        ...
        <div class="container-contact-quote">
          ...
          <div id="container-contact-articles">
            <article>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.139641919952!2d-75.5995054859482!3d6.2453217954793425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4429a39999c271%3A0x1de048aebd5655b0!2sCircular%20Coworking%20La%20Casa%20Redonda!5e0!3m2!1sfr!2sfr!4v1588869108265!5m2!1sfr!2sfr" width="100%" height="300" style="border: 0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
              <div>
                <h3>Medellin</h3>
                <p>Casa Redonda Coworking</p>
                <small>Laureles, Medellin</small>
                <a class="mailtolink" href="mailto:info@quantrack.io">info@quantrack.io</a>
            ...
            <article>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.1536296595855!2d2.3354954152002527!3d48.874347779289145!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e38f6f17aed%3A0xae3da7dd30c8108c!2sWeWork%20La%20Fayette!5e0!3m2!1sfr!2sfr!4v1588844279893!5m2!1sfr!2sfr" width="100%" height="300" style="border: 0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
              <div>
                <h3>Paris</h3>
        ...
        <div class="container-contact-quote">
          ...
          <div id="container-quote-form">
            <form action="./php/controller/FormController.php" method="post">
              <fieldset>
                <input type="text" name="inputName" id="inputName" placeholder="Complete Name" required autocomplete="off" />
                <input type="email" name="inputEmail" id="inputEmail" placeholder="Email" required autocomplete="off" />
              </fieldset>

              <fieldset>
                <input type="text" name="inputCompany" id="inputCompany" placeholder="Company" required autocomplete="off" />
                <input type="text" name="inputPosition" id="inputPosition" placeholder="Position" required autocomplete="off" />
              </fieldset>
              <fieldset>
                <textarea name="inputMessage" id="inputMessage" cols="30" rows="10" required placeholder="Describe your needs" autocomplete="off"></textarea>
              </fieldset>
              <button class="btnlink" id="submitBtn" name="submitBtn" type="submit">
                Send
              </button>
    ...
    <section id="section-quantrack-universe">
      ...
      <div id="container-quantrack-universe">
        ...
        <a class="btnlink" target="blank" href="http://quantrack.io/">Visit Quantrack.io <span><i class="fas fa-chevron-right"></i></span></a>
      </div>
    </section>
  </main>
